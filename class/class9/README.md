...
# Add this line to your bashrc and source it
...
Lets explore the final vcf file generated by the pipeline:
...
You can see that most variants are LOW (synonymous) or MODERATE (non-synonymous). Let's now extract the positions of high impact variants so we can pull them out of the more nicely formatted annotation files.
