...
for i in kraken/*_kraken; do kraken-report --db /scratch/epid582w24_class_root/epid582w24_class/shared_data/data/database/kraken/minikraken_20171013_4GB/ $i > $i\_report.txt; done
